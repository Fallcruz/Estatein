...
export default function Home() {
    return (
        <main className=''>
            ...
            <Navbar />
            <Jumbotron />
            <div className='grid xl:grid-cols-4 grid-cols-2 border-[0.2px] border-grey-15 p-4 gap-4' style={{ boxShadow: '0px 0px 0px 6px #191919' }}>
                <div className='relative flex flex-col xl:p-6 p-5 bg-grey-10 border-[0.2px] border-grey-15 rounded-lg gap-4 items-center justify-center text-center'>
                    ...
                    <div className='text-white text-base font-medium'>Find Your Dream Home</div>
                ...
                <div className='relative flex flex-col xl:p-6 p-5 bg-grey-10 border-[0.2px] border-grey-15 rounded-lg gap-4 items-center justify-center text-center'>
                    ...
                    <div className='text-white text-base font-medium'>Unlock Property Value</div>
                    <svg className='text-grey-30 w-5 h-5 absolute top-4 right-4' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                    </svg>
                </div>
                <div className='relative flex flex-col xl:p-6 p-5 bg-grey-10 border-[0.2px] border-grey-15 rounded-lg gap-4 items-center justify-center text-center'>
                    ...
                    <div className='text-white text-base font-medium'>Effortless Property Management</div>
                    <svg className='text-grey-30 w-5 h-5 absolute top-4 right-4' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                    </svg>
                </div>
                <div className='relative flex flex-col xl:p-6 p-5 bg-grey-10 border-[0.2px] border-grey-15 rounded-lg gap-4 items-center justify-center text-center'>
                    ...
                    <div className='text-white text-base font-medium'>Smart Investments, Informed Decisions</div>
                    <svg className='text-grey-30 w-5 h-5 absolute top-4 right-4' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" />
                    </svg>
                </div>
